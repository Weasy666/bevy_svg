...
impl Plugin for Svg2dPlugin {
    fn build(&self, app: &mut App) {
        ...
        render_app
            .add_render_command::<Transparent2d, pipeline::DrawSvg2d>()
            .init_resource::<pipeline::Svg2dPipeline>()
            .init_resource::<SpecializedPipelines<pipeline::Svg2dPipeline>>()
            .init_resource::<pipeline::ExtractedSvgs2d>()
            .add_system_to_stage(RenderStage::Extract, pipeline::extract_svg_2d)
            .add_system_to_stage(RenderStage::Queue, pipeline::queue_svg_2d);
    }
}
